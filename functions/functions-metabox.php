	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array(
				'id' => 'profile_bsky',
				'type' => 'url',
				'name' => esc_html__( 'BSKY URL', 'metabox-online-generator' ),
			),
			array(
				'id' => 'profile_facebook',
				'type' => 'url',
...
function eventProperties( $meta_boxes ) {
	...
	$meta_boxes[] = array(
		...
		'fields' => [
			...
			[
                'type' => 'url',
                'name' => esc_html__( 'Event Script URL', 'online-generator' ),
                'id'   => $prefix . 'event_script_url',
			],[
                'type' => 'url',
...
function setResourceProperties( $meta_boxes ) { // this shows the box where the scrape and search results
	...
	$meta_boxes[] = array(
		...
		'fields' => [
			...
			[
                'type' => 'url',
                'name' => esc_html__( 'App Store URL', 'online-generator' ),
                'id'   => $prefix . 'app_store_url',
            ],
			[
                'type' => 'url',
                'name' => esc_html__( 'App Download URL', 'online-generator' ),
                'id'   => $prefix . 'app_download_url',
            ],
			[
				'type' => 'textarea',
                'name' => esc_html__( 'App Instructions', 'online-generator' ),
                'id'   => $prefix . 'app_instructions',
            ],
						[
                'type' => 'url',
                'name' => esc_html__( 'App Instructions Video URL', 'online-generator' ),
                'id'   => $prefix . 'app_instructions_video_url',
            ],
			array(
                'type' => 'checkbox',
                'name' => esc_html__( 'Requires Keys', 'online-generator' ),
                'id'   => $prefix . 'app_requires_keys',
			),
