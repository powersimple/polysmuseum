...
define('POLYSMUSEUM_VERSION', '1.0.0');
define('POLYSMUSEUM_DIR', get_template_directory());
define('POLYSMUSEUM_URI', get_template_directory_uri());
...
add_action('after_setup_theme', 'polysmuseum_setup');
...
function replace_home_and_site_url( $url, $path, $orig_scheme, $blog_id ) {
    return str_replace( 'https://thepolys', 'https://obi-wan-v:3000', $url );
}
add_filter( 'home_url', 'replace_home_and_site_url', 10, 4 );
add_filter( 'site_url', 'replace_home_and_site_url', 10, 4 );
