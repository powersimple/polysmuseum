...
<!--                <a-entity troika-text='value:; color:#fff; fontSize:.025;align:center;' material="shader: standard; metalness: 0.8;"
   ...
   <!--TROPHY-->
   <a-entity id="<?=$pedestal['slug']?>-grab" class="clickable grabbable center-obj-zone" static-body="shape: box; mass: 2" position="0 1.090 -0.00014" mixin="obj" rotation="0 -30 0" scale="0.25 0.25 0.25" gltf-model="#trophy">
   <?php
    if($counter==0){}
        ?> 
